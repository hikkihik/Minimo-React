...
class SinglePostSidebar extends Component {
    render() {
        return (
                            ...
                            <Col sm="8" lg="9">
                                <div className="post__content">
                                    ...
                                    <div className="switch-page">
                                        You can switch page to <Link to="/single-post-full-width">Single post full width <FontAwesomeIcon icon={faLongArrowAltRight} /></Link>
                                    </div>
                                </div>
                            </Col>
                            <Col sm="4" lg="3">
